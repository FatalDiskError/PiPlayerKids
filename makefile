...
PLAYER_INCLUDE_PATH = $(BOOST_INCLUDE_PATH) $(BASS_INCLUDE_PATH) $(RFID_INCLUDE_PATH) $(RAPIDXML_INCLUDE_PATH) $(LIBSIG_INCLUDE_PATH)
# $(LIBEV_INCLUDE_PATH)
PLAYER_LIBRARY_PATH = $(BOOST_LIBRARY_PATH) $(BASS_LIBRARY_PATH) $(RFID_LIBRARY_PATH) $(RAPIDXML_LIBRARY_PATH) $(LIBSIG_LIBRARY_PATH)
# $(LIBEV_LIBRARY_PATH)
